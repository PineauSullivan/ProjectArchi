...
public class ConnecteurServeurDetail extends Connecteur{
	...
	public ConnecteurServeurDetail(){
		...
		Glue glueCS1 = new Glue("GlueServeur1", RoleFournis_ConnectionManager_Database, RoleRequis_Database_Connection);
		
		Glue glueCS2 = new Glue("GlueServeur2", RoleFournis_Database_Connection, RoleRequis_ConnectionManager_Database);
		
		Glue glueCS3 = new Glue("GlueServeur3", RoleFournis_ConnectionManager_Security, RoleRequis_Security_Connection);
		
		Glue glueCS4 = new Glue("GlueServeur4", RoleFournis_Security_Connection, RoleRequis_ConnectionManager_Security);
			
		Glue glueCS5 = new Glue("GlueServeur5", RoleFournis_Security_Database, RoleRequis_Database_Security);
		
		Glue glueCS6 = new Glue("GlueServeur6", RoleFournis_Database_Security, RoleRequis_Security_Database);
